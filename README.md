...
# 📖 Хантыйский обучающий Telegram-бот

Этот Telegram-бот разработан для интерактивного обучения хантыйскому языку (восточный диалект), предоставляя пользователям доступ к сказкам, словарю, грамматическим правилам и прогрессу обучения.
...
## ⚙️ Основные модули и их назначение
